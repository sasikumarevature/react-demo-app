...
const CreateCompetency = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.competencyDuration.trim()) {
      ...
      isNaN(formData.competencyDuration) ||
      formData.competencyDuration < 1 ||
      formData.competencyDuration > 52
    ) {
    ...
    try {
      ...
      if (err.response && err.response.status === 409) {
        alert(
          'Conflict occurred: The competency already exists with the selected units.'
        );
      } else {
      ...
      <form onSubmit={handleSubmit}>
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '20px' }}>
          ...
          <div style={{ flex: '0.5' }}>
            ...
            >
              <label style={{ flex: '0.4', fontWeight: 'bold' }}>
                Competency duration:
              </label>
              <input
                type='number'
            ...
            {errors.competencyDuration && (
              <p
                style={{ color: 'red', marginTop: '-5px', marginLeft: '135px' }}
              >
                {errors.competencyDuration}
              </p>
            )}
          ...
          <Row className='mb-3 align-items-center'>
            ...
            <Col md={2} className='text-end'>
              <Link to='/unit/create'>
                <Button
                  variant='primary'
                  className='bg-blue-500 text-white rounded-2xl py-1 px-2 text-base hover:scale-105 float-right'
                >
                  Create Unit
                </Button>
              </Link>
